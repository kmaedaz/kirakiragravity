...
window.onload = function(){
	...
	var LEVEL_arr =[
					// link  データ保存キー
	               ["argon_game0.html","argon_game0"], //0
	               ["argon_game1.html","argon_game1"], //1
	               ["argon_game2.html","argon_game2"], //2
	               ["argon_game3.html","argon_game3"], //3
	               ["argon_game4.html","argon_game4"], //4
	               ["argon_game5.html","argon_game5"], //5
	               ["argon_game6.html","argon_game6"], //6
	               ["argon_game7.html","argon_game7"], //7
	               ["argon_game8.html","argon_game8"], //8
	               ["",""], //12
	               ["",""], //13
	               ["",""], //14
	               ["",""], //15
...
// -----------------------------------------------------------------------
    ...
    core.onload = function() {
		...
		for(var y=0;y<3;y++){
			...
			if( cur_level >= (x+y*3) || cur_stage >= 2 ){
				active_flg = true;
			} else {
				active_flg = false;
			}
...
//			active_flg = true; //debug
        ...
        var menuButton3 = new MenuButton(110, 1520, "neon_world.html", "前へ", IMAGE_PRE_BUTTON);

		if( cur_stage >3){
	        var menuButton2 = new MenuButton(850, 1520, "krypton_world.html", "次へ", IMAGE_NEXT_BUTTON);
		}
