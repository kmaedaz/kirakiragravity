...
window.onload = function(){
	...
	// 背景
    var IMAGE_BACKGROUND_BOTTOM = 'bg/green.png';

    var IMAGE_BACKGROUND_TOP = 'bg/green_top.png';
	...
	var LEVEL_arr =[
					// link  データ保存キー
	               ["krypton_game0.html","krypton_game0"], //0
	               ["krypton_game1.html","krypton_game1"], //1
	               ["krypton_game2.html","krypton_game2"], //2
	               ["krypton_game3.html","krypton_game3"], //3
	               ["krypton_game4.html","krypton_game4"], //4
	               ["krypton_game5.html","krypton_game5"], //5
	               ["krypton_game6.html","krypton_game6"], //6
	               ["krypton_game7.html","krypton_game7"], //7
	               ["krypton_game8.html","krypton_game8"], //8
	               ["",""], //12
	               ["",""], //13
	               ["",""], //14
	               ["",""], //15
...
// -----------------------------------------------------------------------
    ...
    core.onload = function() {
		...
		for(var y=0;y<3;y++){
			...
			if( cur_level >= (x+y*3) || cur_stage > 4 ){
				active_flg = true;
			} else {
				active_flg = false;
			}
...
//			active_flg = true; //debug
        ...
        var menuButton3 = new MenuButton(110, 1520, "argon_world.html", "前へ", IMAGE_PRE_BUTTON);

		if( cur_stage >4){
	        var menuButton2 = new MenuButton(850, 1520, "neon_world.html", "次へ", IMAGE_NEXT_BUTTON);
		}
