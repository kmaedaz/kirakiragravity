...
window.onload = function(){
	...
	var LEVEL_arr =[
					// link  データ保存キー
	               ["radon_game0.html","radon_game0"], //0
	               ["radon_game1.html","radon_game1"], //1
	               ["radon_game2.html","radon_game2"], //2
	               ["radon_game3.html","radon_game3"], //3
	               ["radon_game4.html","radon_game4"], //4
	               ["radon_game5.html","radon_game5"], //5
	               ["radon_game6.html","radon_game6"], //6
	               ["radon_game7.html","radon_game7"], //7
	               ["radon_game8.html","radon_game8"], //8
	               ["",""], //12
	               ["",""], //13
	               ["",""], //14
	               ["",""], //15
...
// -----------------------------------------------------------------------
    ...
    core.onload = function() {
        ...
        var menuButton3 = new MenuButton(110, 1520, "xenon_world.html", "前へ", IMAGE_PRE_BUTTON);

		if( cur_stage >5){
	        var menuButton2 = new MenuButton(850, 1520, "ununoctium_world.html", "次へ", IMAGE_NEXT_BUTTON);
		}
