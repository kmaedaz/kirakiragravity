...
window.onload = function(){
	...
	var LEVEL_arr =[
					// link  データ保存キー
	               ["neon_game0.html","neon_game0"], //0
	               ["neon_game1.html","neon_game1"], //1
	               ["neon_game2.html","neon_game2"], //2
	               ["neon_game3.html","neon_game3"], //3
	               ["neon_game4.html","neon_game4"], //4
	               ["neon_game5.html","neon_game5"], //5
	               ["neon_game6.html","neon_game6"], //6
	               ["neon_game7.html","neon_game7"], //7
	               ["neon_game8.html","neon_game8"], //8
	               ["",""], //12
	               ["",""], //13
	               ["",""], //14
	               ["",""], //15
...
//			active_flg = true; //debug
        ...
        var menuButton3 = new MenuButton(130, 1520, "helium_world.html", "前へ", IMAGE_PRE_BUTTON);

		if( cur_stage >2){
	        var menuButton2 = new MenuButton(850, 1520, "argon_world.html", "次へ", IMAGE_NEXT_BUTTON);
		}
