...
window.onload = function(){
	...
	// 背景
    var IMAGE_BACKGROUND_BOTTOM = 'bg/blue.png';

    var IMAGE_BACKGROUND_TOP = 'bg/blue_top.png';
	...
	var LEVEL_arr =[
					// link  データ保存キー
	               ["helinum_game0.html","helium_game0"], //0
	               ["helinum_game1.html","helium_game1"], //1
	               ["helinum_game2.html","helium_game2"], //2
	               ["helinum_game3.html","helium_game3"], //3
	               ["helinum_game4.html","helium_game4"], //4
	               ["helinum_game5.html","helium_game5"], //5
	               ["helinum_game6.html","helium_game6"], //6
	               ["helinum_game7.html","helium_game7"], //7
	               ["helinum_game8.html","helium_game8"], //8
	               ["",""], //12
	               ["",""], //13
	               ["",""], //14
	               ["",""], //15
...
// -----------------------------------------------------------------------
    ...
    core.onload = function() {
		...
		for(var y=0;y<3;y++){
			...
			if( cur_level >= (x+y*3) || cur_stage > 1 ){
				active_flg = true;
			} else {
				active_flg = false;
			}
        ...
        var menuButton3 = new MenuButton(130, 1520, "free_world.html", "前へ", IMAGE_PRE_BUTTON);
