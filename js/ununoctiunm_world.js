...
window.onload = function(){
	...
	var LEVEL_arr =[
					// link  データ保存キー
	               ["ununoctiunm_game0.html","ununoctiunm_game0"], //0
	               ["ununoctiunm_game1.html","ununoctiunm_game1"], //1
	               ["ununoctiunm_game2.html","ununoctiunm_game2"], //2
	               ["ununoctiunm_game3.html","ununoctiunm_game3"], //3
	               ["ununoctiunm_game4.html","ununoctiunm_game4"], //4
	               ["ununoctiunm_game5.html","ununoctiunm_game5"], //5
	               ["ununoctiunm_game6.html","ununoctiunm_game6"], //6
	               ["ununoctiunm_game7.html","ununoctiunm_game7"], //7
	               ["ununoctiunm_game8.html","ununoctiunm_game8"], //8
	               ["",""], //12
	               ["",""], //13
	               ["",""], //14
	               ["",""], //15
...
// -----------------------------------------------------------------------
    ...
    core.onload = function() {
		...
		for(var y=0;y<3;y++){
			...
			if( cur_level >= (x+y*3) || cur_stage > 6 ){
				active_flg = true;
			} else {
				active_flg = false;
			}
...
//			active_flg = true; //debug
        ...
        var menuButton3 = new MenuButton(130, 1520, "radon_world.html", "前へ", IMAGE_PRE_BUTTON);  
    }
    core.start();
